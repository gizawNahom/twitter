...
export function Nav() {
  ...
  return (
    <nav className="hidden sm:border-r-[1px] sm:basis-1/6 sm:flex sm:flex-col sm:items-center sm:pt-14 sm:h-screen lg:basis-1/4 lg:pl-14">
      <ul>
        <Link href="/home">
          <li className=" text-xl flex gap-4 hover:bg-slate-200 rounded-full py-2 px-4 transition">
            ...
            <span className={`${isHome() ? 'font-bold' : ''} sm:hidden`}>
              Home
            </span>
          </li>
        </Link>
