...
export function Nav() {
  ...
  return (
    <nav
      data-testid="nav"
      className="sm:border-r-[1px] sm:basis-1/6 sm:flex sm:flex-col sm:items-center sm:pt-14 sm:h-screen md:items-end md:pr-5 lg:basis-28 xl:basis-1/4 xl:pl-12 2xl:basis-72"
    >
